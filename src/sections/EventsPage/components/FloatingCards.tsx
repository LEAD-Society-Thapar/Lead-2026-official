...
const EVENTS: EventInfo[] = [
...

  {
    ...
    date: '02-02-2025',
    venue: 'Tan-Audi',
    desc: 'An infiltration-themed experience packed with hidden objectives, tactical decisions, and technical twists. ',
  ...
  },
  {
    ...
    date: '01-02-2025',
    venue: 'Tan-Audi',
    desc: 'Cash or Clash was a high-stakes strategy challenge where participants navigated risk, made calculated decisions, and adapted to unpredictable twists to outsmart the competition.',
  ...
  },
  {
    ...
    date: '31-01-2025',
    venue: 'Tan-Audi',
    desc: 'Escape Nexus is an immersive coding experience designed to ignite analytical thinking and technical excellence. It involved decoding the DSA challenges, finally turning the platform into “debug or die" to escape virtual rooms.',
  ...
  },
  {
    ...
    date: '08-09-2024',
    venue: 'Tan-105',
    desc: 'Inspired by Stranger Things, Vortex is a multi-stage activity where teams solve puzzles, decode secrets, and design creative solutions. Each trial evaluates group collaboration, tactical planning, and collective problem-solving.',
