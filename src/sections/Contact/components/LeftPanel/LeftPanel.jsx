...
function InfoCard({ icon: Icon, title, lines, delayClass }) {
  ...
  return (
    ...
    >
      ...
      <div className="card-icon-container" style={{ marginLeft: '16px' }}>
...
function SocialsCard({ socialLinks, delayClass }) {
  ...
  return (
    <div 
      ...
      style={{ ...style, padding: '13px 13px' }}
    >
      <div className="card-reflection" />
      <div className="card-content socials-card-content">
        <h3 className="socials-card-title" style={{ marginBottom: '10px' }}>FOLLOW LEAD</h3>
